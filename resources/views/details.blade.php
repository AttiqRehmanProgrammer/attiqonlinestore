						...
						<div class="flexslider">
							<ul class="slides">
									...
									<div class="thumb-image">
										<img src="{{asset('uploads/product/' .$product->image)}}" class="img-fluid" alt=""> </div>
						...
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							<form action="#" method="post">
								<fieldset>
									...
									<button type="button" class="btn bg-warning"><i class="fa fa-cart-plus mr-2"></i> Add to cart</button>
